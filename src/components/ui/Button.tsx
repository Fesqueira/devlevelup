...
export function Button({
  ...
  const classes = cn(
    'inline-flex items-center justify-center gap-2 font-display uppercase tracking-wider transition-colors after:block after:h-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-arcade-cyan',
